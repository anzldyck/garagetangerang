<?php
  ...
  if (empty($_SESSION['login_admin'])) {
    ...
    alert('Anda Belum Login!');
      window.location='login4/index.php';
    </script>";
...
<head>
    ...
    <title>Iseng.Iseng Original</title>
  <!-- BOOTSTRAP STYLES-->
    <link href="assets/css/bootstrap.css" rel="stylesheet" />
     <!-- FONTAWESOME STYLES-->
    <link href="assets/css/font-awesome.css" rel="stylesheet" />
        <!-- CUSTOM STYLES-->
    <link href="assets/css/ahay.css" rel="stylesheet" />
     <!-- GOOGLE FONTS-->
    <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
    <!--FOR TABLE -->
    <link href="assets/js/dataTables/dataTables.bootstrap.css" rel="stylesheet" />
    <link rel="shortcut icon" href="gambar_admin/admin.jpg" />
  ...
  <div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php"> <font face="Esporte">A D M I N</font></a> 
      </div>
      <div style="color: white;padding: 15px 20px 15px 20px;float: right;font-size: 16px;"> 
        ...
        <a href="index.php?page=logout" class="btn btn-primary square-btn-adjust">Logout</a> 
      </div>
    </nav>   
<!-- /. NAV TOP  -->
        ...
        <?php  
          if (isset($_GET['page'])) {
            ...
            elseif ($_GET['page']=="logout") {
              session_destroy();
              echo "<script>location='login4/';</script>";
            }
          }
          else{
