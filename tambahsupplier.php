			...
			<div class="box-body">	
				...
				<form method="POST" id="forminput" enctype="multipart/form-data">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="nmsupplier" id="nmsupplier" placeholder="Masukan Nama Supplier">
...
<script>
	...
	$(document).ready(function(){
		$('#nmsupplier').blur(function(){
			var nmsupplier = $(this).val();
			if (nmsupplier == "") {
				$('#showresult').html("");
			}
			else{
				$.ajax({
					url: "validasi/cek-nmsupplier.php?nmsupplier="+nmsupplier
				}).done(function(data){
